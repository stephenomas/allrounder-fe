  ...
  return (
    <Layout>
      ...
      <div className="flex justify-between">
        ...
        <Button className="w-20 mb-3 background-primary-color" onClick={() => openAddModal(false)}>
              ...
              <TableCell>
                <div className="flex items-center space-x-4">
                  ...
                  <Button
                    ...
                    className= {`${branch.status ? 'bg-red-600': 'bg-green-500'} text-white dark:text-white`}
                    layout="link"
                    size="small"
                    aria-label="Delete"
                  >
                   {toggleLoading ? <ButtonSpinner />:branch.status ? 'Disable' : 'Enable'}
                  </Button>
                </div>
              </TableCell>
            </TableRow>
